...
-spec encode_msg(#data{} | #set_request{} | #set_response{} | #get_request{} | #get_response{} | #req_envelope{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#data{} | #set_request{} | #set_response{} | #get_request{} | #get_response{} | #req_envelope{}, atom() | list()) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      data ->
	  encode_msg_data(id(Msg, TrUserData), TrUserData);
      set_request ->
	  encode_msg_set_request(id(Msg, TrUserData), TrUserData);
      set_response ->
	  encode_msg_set_response(id(Msg, TrUserData),
				  TrUserData);
      get_request ->
	  encode_msg_get_request(id(Msg, TrUserData), TrUserData);
      get_response ->
	  encode_msg_get_response(id(Msg, TrUserData),
				  TrUserData);
      req_envelope ->
	  encode_msg_req_envelope(id(Msg, TrUserData), TrUserData)
    end.


encode_msg_data(Msg, TrUserData) ->
    encode_msg_data(Msg, <<>>, TrUserData).


encode_msg_data(#data{key = F1, value = F2}, Bin,
		TrUserData) ->
    B1 = begin
...
encode_msg_set_request(Msg, TrUserData) ->
    encode_msg_set_request(Msg, <<>>, TrUserData).


encode_msg_set_request(#set_request{req = F1}, Bin,
		       TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_set_response(Msg, TrUserData) ->
    encode_msg_set_response(Msg, <<>>, TrUserData).


encode_msg_set_response(#set_response{error = F1}, Bin,
			TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
...
encode_msg_get_request(Msg, TrUserData) ->
    encode_msg_get_request(Msg, <<>>, TrUserData).


encode_msg_get_request(#get_request{key = F1}, Bin,
		       TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      e_type_string(TrF1, <<Bin/binary, 10>>, TrUserData)
...
encode_msg_get_response(Msg, TrUserData) ->
    encode_msg_get_response(Msg, <<>>, TrUserData).


encode_msg_get_response(#get_response{error = F1,
				      req = F2},
			Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
...
encode_msg_req_envelope(Msg, TrUserData) ->
    encode_msg_req_envelope(Msg, <<>>, TrUserData).


encode_msg_req_envelope(#req_envelope{type = F1,
...
'e_enum_set_response.error_t'(ok, Bin, _TrUserData) ->
    <<Bin/binary, 1>>;
'e_enum_set_response.error_t'(internal, Bin,
			      _TrUserData) ->
    <<Bin/binary, 2>>;
'e_enum_set_response.error_t'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).

'e_enum_get_response.error_t'(ok, Bin, _TrUserData) ->
    <<Bin/binary, 1>>;
...
'e_enum_get_response.error_t'(internal, Bin,
			      _TrUserData) ->
    <<Bin/binary, 3>>;
'e_enum_get_response.error_t'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).
...
'e_enum_req_envelope.msg_type'(get_response_t, Bin,
			       _TrUserData) ->
    <<Bin/binary, 4>>;
'e_enum_req_envelope.msg_type'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).
...
decode_msg_2_doit(data, Bin, TrUserData) ->
    id(decode_msg_data(Bin, TrUserData), TrUserData);
decode_msg_2_doit(set_request, Bin, TrUserData) ->
    id(decode_msg_set_request(Bin, TrUserData), TrUserData);
decode_msg_2_doit(set_response, Bin, TrUserData) ->
    id(decode_msg_set_response(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(get_request, Bin, TrUserData) ->
    id(decode_msg_get_request(Bin, TrUserData), TrUserData);
decode_msg_2_doit(get_response, Bin, TrUserData) ->
    id(decode_msg_get_response(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit(req_envelope, Bin, TrUserData) ->
    id(decode_msg_req_envelope(Bin, TrUserData),
       TrUserData).



decode_msg_data(Bin, TrUserData) ->
...
dfp_read_field_def_data(<<10, Rest/binary>>, Z1, Z2,
    ...
    d_field_data_key(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_data(<<18, Rest/binary>>, Z1, Z2,
			F@_1, F@_2, TrUserData) ->
    d_field_data_value(Rest, Z1, Z2, F@_1, F@_2,
		       TrUserData);
dfp_read_field_def_data(<<>>, 0, 0, F@_1, F@_2, _) ->
    #data{key = F@_1, value = F@_2};
dfp_read_field_def_data(Other, Z1, Z2, F@_1, F@_2,
			TrUserData) ->
    dg_read_field_def_data(Other, Z1, Z2, F@_1, F@_2,
			   TrUserData).
...
dg_read_field_def_data(<<0:1, X:7, Rest/binary>>, N,
    ...
    case Key of
      10 ->
	  d_field_data_key(Rest, 0, 0, F@_1, F@_2, TrUserData);
      18 ->
	  d_field_data_value(Rest, 0, 0, F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_data(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    1 -> skip_64_data(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 ->
		skip_length_delimited_data(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
	    3 ->
		skip_group_data(Rest, Key bsr 3, 0, F@_1, F@_2,
				TrUserData);
	    5 -> skip_32_data(Rest, 0, 0, F@_1, F@_2, TrUserData)
	  end
    end;
dg_read_field_def_data(<<>>, 0, 0, F@_1, F@_2, _) ->
    #data{key = F@_1, value = F@_2}.

d_field_data_key(<<1:1, X:7, Rest/binary>>, N, Acc,
		 F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_data_key(Rest, N + 7, X bsl N + Acc, F@_1, F@_2,
		     TrUserData);
d_field_data_key(<<0:1, X:7, Rest/binary>>, N, Acc, _,
    ...
    dfp_read_field_def_data(RestF, 0, 0, NewFValue, F@_2,
			    TrUserData).

d_field_data_value(<<1:1, X:7, Rest/binary>>, N, Acc,
		   F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_data_value(Rest, N + 7, X bsl N + Acc, F@_1,
		       F@_2, TrUserData);
d_field_data_value(<<0:1, X:7, Rest/binary>>, N, Acc,
    ...
    dfp_read_field_def_data(RestF, 0, 0, F@_1, NewFValue,
			    TrUserData).

skip_varint_data(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		 F@_1, F@_2, TrUserData) ->
    skip_varint_data(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
skip_varint_data(<<0:1, _:7, Rest/binary>>, Z1, Z2,
		 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_data(Rest, Z1, Z2, F@_1, F@_2,
			    TrUserData).
...
skip_length_delimited_data(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_data(Rest2, 0, 0, F@_1, F@_2,
			    TrUserData).

skip_group_data(Bin, FNum, Z2, F@_1, F@_2,
		TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_data(Rest, 0, Z2, F@_1, F@_2,
			    TrUserData).
...
decode_msg_set_request(Bin, TrUserData) ->
    dfp_read_field_def_set_request(Bin, 0, 0,
				   id(undefined, TrUserData), TrUserData).

dfp_read_field_def_set_request(<<10, Rest/binary>>, Z1,
			       Z2, F@_1, TrUserData) ->
    d_field_set_request_req(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_set_request(<<>>, 0, 0, F@_1, _) ->
    #set_request{req = F@_1};
dfp_read_field_def_set_request(Other, Z1, Z2, F@_1,
			       TrUserData) ->
    dg_read_field_def_set_request(Other, Z1, Z2, F@_1,
				  TrUserData).
...
dg_read_field_def_set_request(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_set_request_req(Rest, 0, 0, F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_set_request(Rest, 0, 0, F@_1, TrUserData);
	    1 -> skip_64_set_request(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_set_request(Rest, 0, 0, F@_1,
						  TrUserData);
	    3 ->
		skip_group_set_request(Rest, Key bsr 3, 0, F@_1,
				       TrUserData);
	    5 -> skip_32_set_request(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_set_request(<<>>, 0, 0, F@_1, _) ->
    #set_request{req = F@_1}.

d_field_set_request_req(<<1:1, X:7, Rest/binary>>, N,
			Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_set_request_req(Rest, N + 7, X bsl N + Acc,
			    F@_1, TrUserData);
d_field_set_request_req(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = begin
			   ...
			   {id(decode_msg_data(Bs, TrUserData), TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_set_request(RestF, 0, 0,
				   if Prev == undefined -> NewFValue;
				      true ->
					  merge_msg_data(Prev, NewFValue,
							 TrUserData)
				   end,
				   TrUserData).
...
skip_varint_set_request(<<1:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, TrUserData) ->
    skip_varint_set_request(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_set_request(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, TrUserData) ->
    dfp_read_field_def_set_request(Rest, Z1, Z2, F@_1,
				   TrUserData).
...
skip_length_delimited_set_request(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_set_request(Rest2, 0, 0, F@_1,
				   TrUserData).

skip_group_set_request(Bin, FNum, Z2, F@_1,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_set_request(Rest, 0, Z2, F@_1,
				   TrUserData).

skip_32_set_request(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
		    TrUserData) ->
    dfp_read_field_def_set_request(Rest, Z1, Z2, F@_1,
				   TrUserData).

skip_64_set_request(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
		    TrUserData) ->
    dfp_read_field_def_set_request(Rest, Z1, Z2, F@_1,
				   TrUserData).

decode_msg_set_response(Bin, TrUserData) ->
    dfp_read_field_def_set_response(Bin, 0, 0,
				    id(undefined, TrUserData), TrUserData).

dfp_read_field_def_set_response(<<8, Rest/binary>>, Z1,
				Z2, F@_1, TrUserData) ->
    d_field_set_response_error(Rest, Z1, Z2, F@_1,
			       TrUserData);
dfp_read_field_def_set_response(<<>>, 0, 0, F@_1, _) ->
    #set_response{error = F@_1};
dfp_read_field_def_set_response(Other, Z1, Z2, F@_1,
				TrUserData) ->
    dg_read_field_def_set_response(Other, Z1, Z2, F@_1,
				   TrUserData).
...
dg_read_field_def_set_response(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_set_response_error(Rest, 0, 0, F@_1,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_set_response(Rest, 0, 0, F@_1, TrUserData);
	    1 -> skip_64_set_response(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_set_response(Rest, 0, 0, F@_1,
						   TrUserData);
	    3 ->
		skip_group_set_response(Rest, Key bsr 3, 0, F@_1,
					TrUserData);
	    5 -> skip_32_set_response(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_set_response(<<>>, 0, 0, F@_1, _) ->
    #set_response{error = F@_1}.
...
d_field_set_response_error(<<0:1, X:7, Rest/binary>>, N,
			   Acc, _, TrUserData) ->
    {NewFValue, RestF} =
	{id('d_enum_set_response.error_t'(begin
	    ...
	    TrUserData),
	 Rest},
    dfp_read_field_def_set_response(RestF, 0, 0, NewFValue,
				    TrUserData).

skip_varint_set_response(<<1:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, TrUserData) ->
    skip_varint_set_response(Rest, Z1, Z2, F@_1,
			     TrUserData);
skip_varint_set_response(<<0:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, TrUserData) ->
    dfp_read_field_def_set_response(Rest, Z1, Z2, F@_1,
				    TrUserData).
...
skip_length_delimited_set_response(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_set_response(Rest2, 0, 0, F@_1,
				    TrUserData).

skip_group_set_response(Bin, FNum, Z2, F@_1,
			TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_set_response(Rest, 0, Z2, F@_1,
				    TrUserData).

skip_32_set_response(<<_:32, Rest/binary>>, Z1, Z2,
		     F@_1, TrUserData) ->
    dfp_read_field_def_set_response(Rest, Z1, Z2, F@_1,
				    TrUserData).

skip_64_set_response(<<_:64, Rest/binary>>, Z1, Z2,
		     F@_1, TrUserData) ->
    dfp_read_field_def_set_response(Rest, Z1, Z2, F@_1,
				    TrUserData).

decode_msg_get_request(Bin, TrUserData) ->
    dfp_read_field_def_get_request(Bin, 0, 0,
				   id(undefined, TrUserData), TrUserData).

dfp_read_field_def_get_request(<<10, Rest/binary>>, Z1,
			       Z2, F@_1, TrUserData) ->
    d_field_get_request_key(Rest, Z1, Z2, F@_1, TrUserData);
dfp_read_field_def_get_request(<<>>, 0, 0, F@_1, _) ->
    #get_request{key = F@_1};
dfp_read_field_def_get_request(Other, Z1, Z2, F@_1,
			       TrUserData) ->
    dg_read_field_def_get_request(Other, Z1, Z2, F@_1,
				  TrUserData).
...
dg_read_field_def_get_request(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_get_request_key(Rest, 0, 0, F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_get_request(Rest, 0, 0, F@_1, TrUserData);
	    1 -> skip_64_get_request(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_get_request(Rest, 0, 0, F@_1,
						  TrUserData);
	    3 ->
		skip_group_get_request(Rest, Key bsr 3, 0, F@_1,
				       TrUserData);
	    5 -> skip_32_get_request(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_get_request(<<>>, 0, 0, F@_1, _) ->
    #get_request{key = F@_1}.

d_field_get_request_key(<<1:1, X:7, Rest/binary>>, N,
			Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_get_request_key(Rest, N + 7, X bsl N + Acc,
			    F@_1, TrUserData);
d_field_get_request_key(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_get_request(RestF, 0, 0, NewFValue,
				   TrUserData).

skip_varint_get_request(<<1:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, TrUserData) ->
    skip_varint_get_request(Rest, Z1, Z2, F@_1, TrUserData);
skip_varint_get_request(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, TrUserData) ->
    dfp_read_field_def_get_request(Rest, Z1, Z2, F@_1,
				   TrUserData).
...
skip_length_delimited_get_request(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_get_request(Rest2, 0, 0, F@_1,
				   TrUserData).

skip_group_get_request(Bin, FNum, Z2, F@_1,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_get_request(Rest, 0, Z2, F@_1,
				   TrUserData).

skip_32_get_request(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
		    TrUserData) ->
    dfp_read_field_def_get_request(Rest, Z1, Z2, F@_1,
				   TrUserData).

skip_64_get_request(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
		    TrUserData) ->
    dfp_read_field_def_get_request(Rest, Z1, Z2, F@_1,
				   TrUserData).

decode_msg_get_response(Bin, TrUserData) ->
...
dfp_read_field_def_get_response(<<8, Rest/binary>>, Z1,
    ...
    d_field_get_response_error(Rest, Z1, Z2, F@_1, F@_2,
			       TrUserData);
dfp_read_field_def_get_response(<<18, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, TrUserData) ->
    d_field_get_response_req(Rest, Z1, Z2, F@_1, F@_2,
			     TrUserData);
dfp_read_field_def_get_response(<<>>, 0, 0, F@_1, F@_2,
				_) ->
    #get_response{error = F@_1, req = F@_2};
dfp_read_field_def_get_response(Other, Z1, Z2, F@_1,
				F@_2, TrUserData) ->
    dg_read_field_def_get_response(Other, Z1, Z2, F@_1,
				   F@_2, TrUserData).
...
dg_read_field_def_get_response(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_get_response_error(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
      18 ->
	  d_field_get_response_req(Rest, 0, 0, F@_1, F@_2,
				   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_get_response(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
	    1 ->
		skip_64_get_response(Rest, 0, 0, F@_1, F@_2,
				     TrUserData);
	    2 ->
		skip_length_delimited_get_response(Rest, 0, 0, F@_1,
						   F@_2, TrUserData);
	    3 ->
		skip_group_get_response(Rest, Key bsr 3, 0, F@_1, F@_2,
					TrUserData);
	    5 ->
		skip_32_get_response(Rest, 0, 0, F@_1, F@_2, TrUserData)
	  end
    end;
dg_read_field_def_get_response(<<>>, 0, 0, F@_1, F@_2,
			       _) ->
    #get_response{error = F@_1, req = F@_2}.
...
d_field_get_response_error(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} =
	{id('d_enum_get_response.error_t'(begin
					    <<Res:32/signed-native>> = <<(X bsl
									    N
									    +
									    Acc):32/unsigned-native>>,
	    ...
	    TrUserData),
	 Rest},
    dfp_read_field_def_get_response(RestF, 0, 0, NewFValue,
				    F@_2, TrUserData).

d_field_get_response_req(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_get_response_req(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, TrUserData);
d_field_get_response_req(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_get_response(RestF, 0, 0, F@_1,
				    if Prev == undefined -> NewFValue;
				       true ->
					   merge_msg_data(Prev, NewFValue,
							  TrUserData)
...
skip_varint_get_response(<<1:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_get_response(Rest, Z1, Z2, F@_1, F@_2,
			     TrUserData);
skip_varint_get_response(<<0:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_get_response(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData).
...
skip_length_delimited_get_response(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_get_response(Rest2, 0, 0, F@_1, F@_2,
				    TrUserData).

skip_group_get_response(Bin, FNum, Z2, F@_1, F@_2,
			TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_get_response(Rest, 0, Z2, F@_1, F@_2,
				    TrUserData).

skip_32_get_response(<<_:32, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_get_response(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData).

skip_64_get_response(<<_:64, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_get_response(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData).

decode_msg_req_envelope(Bin, TrUserData) ->
...
dfp_read_field_def_req_envelope(<<8, Rest/binary>>, Z1,
    ...
    d_field_req_envelope_type(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_req_envelope(<<18, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_req_envelope_set_req(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_req_envelope(<<26, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_req_envelope_set_resp(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_req_envelope(<<34, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_req_envelope_get_req(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_req_envelope(<<42, Rest/binary>>, Z1,
				Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_req_envelope_get_resp(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, F@_4, F@_5, TrUserData);
dfp_read_field_def_req_envelope(<<>>, 0, 0, F@_1, F@_2,
				F@_3, F@_4, F@_5, _) ->
    #req_envelope{type = F@_1, set_req = F@_2,
		  set_resp = F@_3, get_req = F@_4, get_resp = F@_5};
dfp_read_field_def_req_envelope(Other, Z1, Z2, F@_1,
				F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dg_read_field_def_req_envelope(Other, Z1, Z2, F@_1,
				   F@_2, F@_3, F@_4, F@_5, TrUserData).
...
dg_read_field_def_req_envelope(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_req_envelope_type(Rest, 0, 0, F@_1, F@_2, F@_3,
				    F@_4, F@_5, TrUserData);
      18 ->
	  d_field_req_envelope_set_req(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, TrUserData);
      26 ->
	  d_field_req_envelope_set_resp(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, F@_5, TrUserData);
      34 ->
	  d_field_req_envelope_get_req(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, TrUserData);
      42 ->
	  d_field_req_envelope_get_resp(Rest, 0, 0, F@_1, F@_2,
					F@_3, F@_4, F@_5, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_req_envelope(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, F@_5, TrUserData);
	    1 ->
		skip_64_req_envelope(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				     F@_5, TrUserData);
	    2 ->
		skip_length_delimited_req_envelope(Rest, 0, 0, F@_1,
						   F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
	    3 ->
		skip_group_req_envelope(Rest, Key bsr 3, 0, F@_1, F@_2,
					F@_3, F@_4, F@_5, TrUserData);
	    5 ->
		skip_32_req_envelope(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
				     F@_5, TrUserData)
	  end
    end;
dg_read_field_def_req_envelope(<<>>, 0, 0, F@_1, F@_2,
			       F@_3, F@_4, F@_5, _) ->
    #req_envelope{type = F@_1, set_req = F@_2,
		  set_resp = F@_3, get_req = F@_4, get_resp = F@_5}.
...
d_field_req_envelope_type(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} =
	{id('d_enum_req_envelope.msg_type'(begin
					     <<Res:32/signed-native>> = <<(X bsl
									     N
									     +
									     Acc):32/unsigned-native>>,
	    ...
	    TrUserData),
	 Rest},
    dfp_read_field_def_req_envelope(RestF, 0, 0, NewFValue,
				    F@_2, F@_3, F@_4, F@_5, TrUserData).
...
d_field_req_envelope_set_req(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_set_request(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_req_envelope(RestF, 0, 0, F@_1,
				    if Prev == undefined -> NewFValue;
				       true ->
					   merge_msg_set_request(Prev,
								 NewFValue,
								 TrUserData)
				    end,
				    F@_3, F@_4, F@_5, TrUserData).
...
d_field_req_envelope_set_resp(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_set_response(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_req_envelope(RestF, 0, 0, F@_1, F@_2,
				    if Prev == undefined -> NewFValue;
				       true ->
					   merge_msg_set_response(Prev,
								  NewFValue,
								  TrUserData)
				    end,
				    F@_4, F@_5, TrUserData).
...
d_field_req_envelope_get_req(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_get_request(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_req_envelope(RestF, 0, 0, F@_1, F@_2,
...
d_field_req_envelope_get_resp(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_get_response(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_req_envelope(RestF, 0, 0, F@_1, F@_2,
...
skip_varint_req_envelope(<<1:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    skip_varint_req_envelope(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     F@_4, F@_5, TrUserData);
skip_varint_req_envelope(<<0:1, _:7, Rest/binary>>, Z1,
			 Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_req_envelope(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData).
...
skip_length_delimited_req_envelope(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_req_envelope(Rest2, 0, 0, F@_1, F@_2,
				    F@_3, F@_4, F@_5, TrUserData).

skip_group_req_envelope(Bin, FNum, Z2, F@_1, F@_2, F@_3,
			F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_req_envelope(Rest, 0, Z2, F@_1, F@_2,
				    F@_3, F@_4, F@_5, TrUserData).

skip_32_req_envelope(<<_:32, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_req_envelope(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData).

skip_64_req_envelope(<<_:64, Rest/binary>>, Z1, Z2,
		     F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_req_envelope(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, TrUserData).
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      set_request ->
	  v_msg_set_request(Msg, [MsgName], TrUserData);
      set_response ->
	  v_msg_set_response(Msg, [MsgName], TrUserData);
      get_request ->
	  v_msg_get_request(Msg, [MsgName], TrUserData);
      get_response ->
	  v_msg_get_response(Msg, [MsgName], TrUserData);
      req_envelope ->
	  v_msg_req_envelope(Msg, [MsgName], TrUserData);
...
v_msg_data(#data{key = F1, value = F2}, Path,
	   TrUserData) ->
...
v_msg_set_response(#set_response{error = F1}, Path,
		   TrUserData) ->
    'v_enum_set_response.error_t'(F1, [error | Path],
				  TrUserData),
    ok;
...
v_msg_get_request(#get_request{key = F1}, Path,
		  TrUserData) ->
    v_type_string(F1, [key | Path], TrUserData), ok;
...
v_msg_req_envelope(#req_envelope{type = F1,
    ...
    ok;
v_msg_req_envelope(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, req_envelope}, X, Path).

-compile({nowarn_unused_function,'v_enum_set_response.error_t'/3}).
-dialyzer({nowarn_function,'v_enum_set_response.error_t'/3}).
'v_enum_set_response.error_t'(ok, _Path, _TrUserData) ->
    ok;
'v_enum_set_response.error_t'(internal, _Path,
			      _TrUserData) ->
    ok;
'v_enum_set_response.error_t'(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_set_response.error_t'(X, Path, _TrUserData) ->
...
'v_enum_get_response.error_t'(ok, _Path, _TrUserData) ->
    ok;
'v_enum_get_response.error_t'(not_found, _Path,
			      _TrUserData) ->
    ok;
'v_enum_get_response.error_t'(internal, _Path,
			      _TrUserData) ->
    ok;
'v_enum_get_response.error_t'(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_get_response.error_t'(X, Path, _TrUserData) ->
...
'v_enum_req_envelope.msg_type'(get_response_t, _Path,
			       _TrUserData) ->
    ok;
'v_enum_req_envelope.msg_type'(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_req_envelope.msg_type'(X, Path, _TrUserData) ->
...
get_msg_names() ->
    [data, set_request, set_response, get_request,
     get_response, req_envelope].
...
get_msg_containment("kv") ->
    [data, get_request, get_response, req_envelope,
...
get_enum_containment("kv") ->
    ['get_response.error_t', 'req_envelope.msg_type',
     'set_response.error_t'];
